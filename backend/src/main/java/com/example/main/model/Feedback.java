...
public class Feedback {
    ...
    public void setU_satisfaction(String u_satisfaction) { this.u_satisfaction = u_satisfaction; }    
    public Boolean getU_recommendation() { return u_recommendation; }
    public void setU_recommendation(Boolean u_recommendation) { this.u_recommendation = u_recommendation; }
    public String getU_used_feature() { return u_used_feature; }
    public void setU_used_feature(String u_used_feature) { this.u_used_feature = u_used_feature; }
    public String getU_issues_faced() { return u_issues_faced; }
    public void setU_issues_faced(String u_issues_faced) { this.u_issues_faced = u_issues_faced; }
    public String getU_suggestions() { return u_suggestions; }
