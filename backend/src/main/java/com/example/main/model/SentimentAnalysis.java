...
public class SentimentAnalysis {
    ...
    public SentimentAnalysis(Long id, Long fb_id, String fb_frequency, String fb_suggestions, String fb_satisfaction, String fb_issues_faced, String fb_recommendation, String fb_overall_summary) {
        this.id = id;
        this.fb_id = fb_id;
